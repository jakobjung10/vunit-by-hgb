...
export class VunitTestController {
    ...
    private async RunVunitTestsDefault(request : vscode.TestRunRequest, node : vscode.TestItem, run: vscode.TestRun)
    {
